		...
		<main>
			<section>
				<form method="post" action="${pageContext.request.contextPath}/join">
					...
					<div class="m-2">
						<label></label><span style="font-size:.7rem;color:orange;marign:0 10px;">${password}</span>
						<input class="form-control" name="password" placeholder="password">	
					</div>
					<div class="m-2">
						<label></label><span style="font-size:.7rem;color:orange;marign:0 10px;">${repassword}</span>
						<input class="form-control" name="repassword" placeholder="repassword">	
					</div>
					<div class="m-2">
						<label></label><span style="font-size:.7rem;color:orange;marign:0 10px;">${nickname}</span>
						<input class="form-control" name="nickname" placeholder="nickname">	
					</div>
					<div class="m-2">
						<label></label><span style="font-size:.7rem;color:orange;marign:0 10px;">${phone}</span>
						<input class="form-control" name="phone" placeholder="phone">	
					</div>
					<div class="m-2">
						<label></label><span style="font-size:.7rem;color:orange;marign:0 10px;">${address}</span>
						<input class="form-control" name="address" placeholder="address">	
					</div>
					<div class="m-2">
						<label></label><span style="font-size:.7rem;color:orange;marign:0 10px;">${birthday}</span>
